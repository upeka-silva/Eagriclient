...
export const downloadInterProvincialADAExcel = async (
  onSuccess = () => {},
  onError = (_message) => {}
) => {
  try {
    const blobData = await getBlob("geo-data/interprovincial-ada-segments/export/excel", true);
    if (blobData) {
      const fileName = `geo-data/interprovincial-ada-segments_${
