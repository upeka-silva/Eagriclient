...
export const handleScsRegion = async (
  payload = {},
  onSuccess = () => {},
  onError = (_message) => {}
) => {
...
export const updateScsRegion = async (
  payload = {},
  onSuccess = () => {},
  onError = (_message) => {}
) => {
  try {
    const response = await put(
      `geo-data/scs-regions/${payload?.id || ""}`,
      payload,
      true
    );
    if (response.httpCode === "200 OK") {
...
export const deleteScsRegion = async (
  id,
  onSuccess = () => {},
  onError = (_message) => {}
) => {
