...
import {
    ...
    getFormTemplatesByFormLandId, saveFormDataWithValues,
...
/*            if (formData?.id) {
    ...
    return (
        <div>
            <CustFormHeader isShowAction={false} saving={saving} state={state} formName="Self Assessment List" />

            {(dialogMode === null || dialogMode === DEF_ACTIONS.ADD) &&
             <DynamicFormFarmLand auditFormType={auditFormType} afterSave={onSuccess} />
            }
