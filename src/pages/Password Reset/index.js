...
const PasswordResetPage = () => {
    ...
    return (
        <ThemeProvider theme={theme}>
            <ContainerWithBG background={BGImage} type={ContainerTypes.div} component="main" overlayColor="to top, rgba(245, 246, 252, 0.52), rgba(19, 117, 93, 0.73)">
                <CssBaseline />
                <CustomCard>
                    <Box
                        maxWidth='xs'
                    ...
                    >
                        ...
                        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 3 }}>
                            ...
                            />
                            {
                                ...
                                <FormHelperText id="old-password-error" error>Please enter your old password</FormHelperText>
                            }
                            <TextField
                                margin="normal"
                                required
                            ...
                            {(
                                ...
                                <FormHelperText id="confirm-password-error" error>Passwords do not match</FormHelperText>
                            }
                            <ButtonContainer>
                                <Button
                                    type="submit"
