...
import { handleMahaweliUnit, updateMahaweliUnit } from "../../../redux/actions/mahaweliUnit/action";
  ...
  return (
    <FormWrapper>
      ...
      <FormHeader style={{ padding: "0px 15px" }}>
        ...
        {makeCapitalize(state?.action)} Mahaweli Unit
      </FormHeader>
      <ButtonWrapper
        isCeneter
        style={{
        ...
        <Grid item lg={3}>
          <FieldWrapper>
            ...
            <TextField
              ...
              onChange={(e) =>
                handleChange(e?.target?.value || "", "unitId")
              }
              sx={{
                // width: "264px",
                "& .MuiInputBase-root": {
