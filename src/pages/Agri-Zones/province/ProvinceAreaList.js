...
const rows = [
  {
    id: 1,
    provinceAreaCode: window.btoa(new Date().valueOf()),
...
const ProvinceAreaList = ({
  ...
  onEdit = (_province) => {},
  onDelete = (_province) => {},
  selectedProvincesArea = [],
  setSelectedProvincesArea,
  selectAllProvincesArea,
  removeSelectedProvincesArea,
}) => {
  const columns = [
    {
      // headerName: 'Actions',
    ...
    { field: "provinceAreaCode", headerName: "Province Area Code", searchable: true },
  ...
  return (
    ...
    <DataTable
      ...
      advanceSearchProps={{
        provinceAreaId: {
              label: 'Province Area',
              target: 'provinceAreaId',
              type: 'select',
              multiple: true,
              listTarget: 'id',
              listLabels: ['description'],
              dataList: [
                  { id: 1, description: "Central Province", provinceAreaCode: 'P1' },
                  { id: 2, description: "Central Province", provinceAreaCode: 'P1' },
                  { id: 3, description: "Central Province", provinceAreaCode: 'P1' },
  
              ]
          },
          provinceAreaCode: {
              label: 'Code',
              target: 'provinceAreaCode',
              type: 'text'
          },
          createdDate: {
              label: 'Created At',
      ...
      selectable
      selectedRows={selectedProvincesArea}
      onRowSelect={setSelectedProvincesArea}
      selectAll={selectAllProvincesArea}
      unSelectAll={removeSelectedProvincesArea}
    ></DataTable>
  </CardWrapper>
  );
};
